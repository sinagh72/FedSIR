...
from algorithm.helper import weighted_average_state_dicts, state_dict_to_cpu
from algorithm.identification import identification_process



def run_pruning(cfg, gamma_s, num_classes, base_state, train_loaders_train, test_loader, cfg_identification, cfg_train, save_dir, device):
